...
\newpage
\section{Úvod}
V této dokumentaci naleznete popis návrhu a implementace interpretu jazyka IFJ16, který je velmi zjednodušenou podmnožinou jazyka Java SE 8, což je staticky typovaný objektově orientovaný jazyk. Vybrali jsme si variantu  a/3/I, což znamená, že funkce find využívá \emph{Knuth-Morris-Prattův algoritmus}, ve funkci sort je použit řadící algoritmus \emph{shell sort} a tabulka symbolů je implementovaná binárním vyhledávacím stromem.
...
Ekvivaletní sémantická akce k redukci je generování AST. Adresa jeho kořene je uložená v struktuře terminálu.
...
Konkrétní podoba naší tabulky viz příloha na straně \pageref{tab:SA-precedence}.
